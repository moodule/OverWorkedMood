...
Report bugs at https://github.com/moodule/overworked/issues.
...
Overworked could always use more documentation, whether as part of the
official Overworked docs, in docstrings, or even on the web in blog posts,
articles, and such.

Submit Feedback
~~~~~~~~~~~~~~~

The best way to send feedback is to file an issue at https://github.com/moodule/overworked/issues.
...
Ready to contribute? Here's how to set up `overworked` for local development.

1. Fork the `overworked` repo on GitHub.
2. Clone your fork locally::

    $ git clone git@github.com:your_name_here/overworked.git
...
3. The pull request should work for Python 2.7, 3.5, 3.6 and 3.7, and for PyPy. Check
   https://travis-ci.org/moodule/overworked/pull_requests
